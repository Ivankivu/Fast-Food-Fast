...
class TestUser(unittest.TestCase):
    ...
    def test_if_json_data(self):
        ...
        """
        with self.client:
            response = self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "1234567")
            self.assertTrue(response.content_type == 'application/json')
    
    def test_adduser_when_json_is_not_provided(self):
        with self.client:
            response = self.User("ivankivumbi", "ivankivumbi@gmail.com", "1234567")
    ...
    #     """
    #     with self.client:
    #         self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "1234567")
    #         response = self.adduser("boolean", "ivankivumbi@gmail.com", "Bootcamp12")
    #         data = json.loads(response.data.decode())
    ...
    def test_invalid_email(self):
        ...
        """
        with self.client:
            response = self.adduser("ivankivumbi", "ivankivumbigmail.com", "1234567")
            with self.assertRaises(Exception) as context:
                response
                self.assertTrue('Enter Valid Email ID forexample ivankivumbi@gmail.com' in str(context.exception))
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "bootcamp")
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "Boo")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("su", "ivankivumbi@gmail.com", "greetings")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "yyyyyyyyyyyy")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("su", "ivankivumbi@gmail.com", "1234567")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     """
    #     with self.client:
    #         response = self.adduser("@#$$$$$", "ivankivumbi@gmail'.com", "1234567")
    #         with self.assertRaises(Exception) as context:
    #             response
    ...
    #     with self.client:
    #         self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "1234567")
    #         response = self.login_user("ivankivumbi@gmail.com", "1234567")
    ...
    #     self.adduser("ivankivumbi", "ivankivumbi@gmail.com", "1234567")
    #     response = self.login_user2("ivankivumbi@gmail.com", "1234567")
    #     data = json.loads(response.data.decode())
    #     self.assertEqual(data.get('message'), "Request should be json")
    #     self.assertEqual(response.status_code, 400)
